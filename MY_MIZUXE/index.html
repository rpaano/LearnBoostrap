        ...
        <div class="row">
          <div class="col">
            <div class="info-header mb-5">
              ...
              <p class="lead pb-3">
                Lorem, ipsum dolor sit amet consectetur adipisicing elit. Incidunt nam, assumenda consequatur commodi temporibus aliquid!
              </p>
            </div>
            ...
            <div id="accordion">
              <div class="card">
                ...
                <div id="collapse1" class="collapse show">
                  <div class="card-body">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum soluta esse quasi deleniti non labore culpa doloribus porro, placeat quae, molestiae voluptatem quibusdam nihil assumenda quia fugit. Repellat animi odio obcaecati nesciunt voluptates, expedita sapiente accusantium id dolor repudiandae culpa nobis est tenetur molestiae. Sed voluptas molestiae quaerat qui autem?
                  </div>
                </div>
              </div>
              <div class="card">
        ...
        <div class="row">
          <div class="col">
            <div class="info-header mb-5">
              ...
              <p class="lead">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, dolores! Nisi deserunt voluptatum cumque dicta.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card">
              <div class="card-body text-center">
                ...
                <h5 class="text-muted">Lead Whiter</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad deserunt praesentium voluptates provident nostrum totam!</p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card">
              <div class="card-body text-center">
                ...
                <h3>Susan Williams</h3>
                <h5 class="text-muted">Kevin Swanson</h5>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad deserunt praesentium voluptates provident nostrum totam!</p>
                <div class="d-flex justify-content-center">
                  <div class="p-4">
                    <a href="http://facebook.com">
